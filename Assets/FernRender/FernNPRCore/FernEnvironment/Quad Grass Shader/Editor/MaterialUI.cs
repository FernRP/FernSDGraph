...
namespace StylizedGrass
{
    ...
    public class MaterialUI : ShaderGUI
    {
        ...
        private MaterialProperty _UpNormal;
        ...
        public void FindProperties(MaterialProperty[] props, Material material)
        {
            ...
            _UpNormal = FindProperty("_UpNormal", props);
        ...
        private void DrawShading()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(shadingSection.anim.faded))
            {
                ...
                materialEditor.ShaderProperty(_UpNormal, new GUIContent("Flatten normals (lighting)", "Gradually has the normals point straight up, this will help match the shading to the surface the grass is placed on."));
