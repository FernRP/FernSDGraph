    ...
    public class StylizedGrassRenderer : MonoBehaviour
    {
        ...
        private void UpdateWind()
        {
            if (listenToWindZone && windZone && windZone.gameObject.activeInHierarchy)
            {
                ...
                globalWindParams.y = Mathf.Max(0, windZone.windMain);
                globalWindParams.z = Mathf.Max(0, windZone.windTurbulence);
                ...
                gustOffset += windDirection * (windZone.windTurbulence * (float)deltaTime);
