...
namespace AwesomeTechnologies.Shaders
{
    public class StylizedGrassShaderController : IShaderController
    {
        ...
        public void CreateDefaultSettings(Material[] materials)
        {
            ...
            Settings.AddFloatProperty("_UpNormal", "Flatten normals (lighting)", "", ShaderControllerSettings.GetFloatFromMaterials(materials, "_UpNormal"), 0, 1);
        ...
        public void UpdateMaterial(Material material, EnvironmentSettings environmentSettings)
        {
            ...
            material.SetFloat("_UpNormal", Settings.GetFloatPropertyValue("_UpNormal"));
        ...
        public void UpdateWind(Material material, WindData windSettings)
        {
        }
    }
}
