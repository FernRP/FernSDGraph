...
{
    half radiance = lightingData.NdotLClamp * lightingData.ShadowAttenuation;
    return radiance;
}
 ...
 * \param diffuse [Out]
 */
inline half3 CellShadingDiffuse(inout half radiance, half cellThreshold, half cellSmooth, half3 lightenColor, half3 darkColor)
{
    half3 diffuse = 0;
    //cellSmooth *= 0.5;
...
half3 StylizedSpecular(half3 albedo, half ndothClamp, half specularSize, half specularSoftness)
{
