...
//=====================================
        ...
        void ProcessSubTargetDatas(SubTarget subTarget)
        {
            ...
            foreach (var type in typeCollection)
            {
                ...
                var methodInfo = typeof(FernSG_UniversalTarget).GetMethod(nameof(SetDataOnSubTarget));
        ...
        void ClearUnusedData()
        {
            for (int i = 0; i < m_Datas.Count; i++)
            {
                ...
                // Data requirement interfaces need generic type arguments
                // Therefore we need to use reflections to call the method
                var methodInfo = typeof(FernSG_UniversalTarget).GetMethod(nameof(ValidateDataForSubTarget));
                var genericMethodInfo = methodInfo.MakeGenericMethod(type);
    ...
    static class CorePasses
    {
        ...
        internal static void AddAlphaToMaskControlToPass(ref PassDescriptor pass, FernSG_UniversalTarget target)
        {
        ...
        internal static void AddAlphaClipControlToPass(ref PassDescriptor pass, FernSG_UniversalTarget target)
        {
            if (target.allowMaterialOverride)
        ...
        internal static void AddLODCrossFadeControlToPass(ref PassDescriptor pass, FernSG_UniversalTarget target)
        {
        ...
        public static PassDescriptor DepthOnly(FernSG_UniversalTarget target)
        {
        ...
        public static PassDescriptor ShadowCaster(FernSG_UniversalTarget target)
        {
            var result = new PassDescriptor()
            {
                // Definition
        ...
        public static PassDescriptor SceneSelection(FernSG_UniversalTarget target)
        {
            var result = new PassDescriptor()
            {
                // Definition
        ...
        public static PassDescriptor ScenePicking(FernSG_UniversalTarget target)
        {
            var result = new PassDescriptor()
            {
                // Definition
        ...
        public static PassDescriptor _2DSceneSelection(FernSG_UniversalTarget target)
        {
            var result = new PassDescriptor()
            {
                // Definition
        ...
        public static PassDescriptor _2DScenePicking(FernSG_UniversalTarget target)
        {
            var result = new PassDescriptor()
            {
                // Definition
    ...
    static class CoreRenderStates
    {
        ...
        public static RenderStateDescriptor UberSwitchedCullRenderState(FernSG_UniversalTarget target)
        {
            if (target.allowMaterialOverride)
        ...
        // used by lit/unlit targets
        public static RenderStateCollection ShadowCaster(FernSG_UniversalTarget target)
        {
            var result = new RenderStateCollection
            {
                { RenderState.ZTest(ZTest.LEqual) },
        ...
        // used by lit/unlit targets
        public static RenderStateCollection DepthOnly(FernSG_UniversalTarget target)
        {
            var result = new RenderStateCollection
            {
                { RenderState.ZTest(ZTest.LEqual) },
        ...
        // used by lit target ONLY
        public static RenderStateCollection DepthNormalsOnly(FernSG_UniversalTarget target)
        {
            var result = new RenderStateCollection
            {
                { RenderState.ZTest(ZTest.LEqual) },
        ...
        // Used by all targets
        public static RenderStateCollection SceneSelection(FernSG_UniversalTarget target)
        {
            var result = new RenderStateCollection
            {
                { RenderState.Cull(Cull.Off) },
        ...
        public static RenderStateCollection ScenePicking(FernSG_UniversalTarget target)
        {
            var result = new RenderStateCollection
            {
                { UberSwitchedCullRenderState(target) }
