...
{
    abstract class FernSG_UniversalSubTarget : SubTarget<FernSG_UniversalTarget>, IHasMetadata
#if HAS_VFX_GRAPH
        , IRequireVFXContext
#endif
    {
        static readonly GUID kSourceCodeGuid = new GUID("92228d45c1ff66740bfa9e6d97f7e280");  // FernSG_UniversalSubTarget.cs
        ...
        {
            var urpMetadata = ScriptableObject.CreateInstance<FernSG_UniversalMetadata>();
