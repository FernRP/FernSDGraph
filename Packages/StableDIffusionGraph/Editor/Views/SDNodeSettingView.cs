...
namespace UnityEditor.SDGraph
{
	public class SDNodeSettingView : VisualElement
	{
        ...
        StableDiffusionGraphView    owner;
        SDNodeSetting     settings;
        StableDiffusionGraph        graph;
        string              title;
        ...
        public SDNodeSettingView(SDNodeSetting settings, StableDiffusionGraphView owner, string title = "Node Output Settings", bool showSettingsForNode = true)
        {
            this.graph = owner.graph as StableDiffusionGraph;
		...
		void AddRealtimeFields(StableDiffusionGraphView owner)
		{
		...
		void UpdateFieldVisibility(SDNodeSetting settings)
		{
