...
#ifdef CRT_CUBE
#define FIX_CUBEMAP_DIRECTION(crt) crt.direction = normalize(crt.direction)
#else
...
float4 SDMixFrag(v2f_customrendertexture i);

float4 SDMixFragment (v2f_customrendertexture i) : SV_Target
{
